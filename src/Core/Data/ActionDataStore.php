...
class ActionDataStore
{
    ...
    public function __construct(ContainerInterface $container)
    {
        ...
        $this->config = $container->get(ConfigRegistry::class);
    }
    ...
    public function createAction(Action $action) : bool
    {
        try {
            ...
            $count = $this->dbs->insert($sql, $action->getArray());
            $action->setId((int)$this->dbs->lastInsertId());
            return $count === 1;
        }
