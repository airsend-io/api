 ...
 */
class ActionTask extends AbstractCronTask
{
    ...
    public function __construct(LoggerService $logger, ActionOperations $operations)
    {
        $this->logger = $logger;
    ...
    {
        $this->logger->debug("DAILY ACTION CRON");
