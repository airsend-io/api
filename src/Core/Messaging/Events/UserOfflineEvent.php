...
class UserOfflineEvent extends  ASEvent implements RtmInterface
{
    public const NAME = 'user.offline';
    ...
    {
        return array('channelid' => $this->channelId, 'user' => $this->user->getArray());
    }
}
